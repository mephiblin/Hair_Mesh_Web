...
> 현재 구현 기준: 기본 브랜치 `master` 작업 트리(2026-08-09). 원격 기능 기준은 `969a05e`이며, 현재 Node 계약 31/31, 브라우저 self-test 24/24, 로컬 Viewport 회귀 통과 상태입니다. 문서의 줄 번호보다 함수명·DOM ID·모듈 경로를 우선합니다.
