...
> 현재 구현 기준: 기본 브랜치 `master` 작업 트리(2026-08-09). Soft Selection 직전 원격 체크포인트는 `c243711`이며, 현재 Node 계약 34/34, 브라우저 self-test 24/24, 로컬 Viewport 회귀 통과 상태입니다. 문서의 줄 번호보다 함수명·DOM ID·모듈 경로를 우선합니다.
